        ...
        <div class="flex flex-col min-h-screen">
          <div class="bg-gray-800">
                ...
                <div class="sm:pl-10 sm:pt-4 flex-1">
                  <div class="flex sm:justify-between sm:flex-row sm:flex-no-wrap justify-center flex-wrap mb-6">
                    <div class="flex flex-wrap md:w-auto w-full md:mb-0 mb-4">
                      <h2 class="text-white text-2xl w-full mb-3 text-center sm:text-left mt-4 sm:mt-0">
                        Phoebe Caulfield
                      </h2>
                      <div class="flex sm:w-auto w-full sm:justify-start justify-center">
                        <span class="text-gray-600 mr-4 tracking-wider">
                          <span class="text-gray-400">120</span> Followers
                        </span>
                        <span class="text-gray-600 mr-4 tracking-wider">
                          <span class="text-gray-400">45</span> Following
                        </span>
                      </div>
                  ...
                  <p class="text-gray-500 leading-normal px-4 sm:px-0">
                    ...
                    newspaper. The marketing may be in the form of a heart to
                    heart.
                  </p>
                </div>
              </div>
            ...
            <div class="flex justify-center border-t border-gray-700 py-5">
              ...
              <a href="#" class="text-gray-600 mx-5 hover:text-gray-500">
                Recommends
              </a>
              <a href="#" class="text-gray-600 mx-5 hover:text-gray-500">
                Subscriptions
          ...
          <div class="bg-gray-900 pt-12 pb-6 flex-1">
            <div class="container mx-auto">
              <div class="flex flex-wrap md:-mx-3">
                <div class="md:w-1/2 px-3 mb-6 w-full">
                  <div class="flex w-full h-full flex-wrap bg-gray-800 overflow-hidden rounded">
                    ...
                    <div class="w-4/6 p-5">
                      <h2 class="text-white leading-normal text-lg">
              ...
              <div class="text-center">
                <button class="border border-gray-600 text-gray-600 px-4 py-2 rounded-full hover:bg-gray-600 hover:text-white">
                  Show More
                </button>
              </div>
            </div>
